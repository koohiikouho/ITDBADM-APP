...
export const RoleBasedNavbar = () => {
  ...
  useEffect(() => {
    ...
    // Fetch currency and store in localStorage
    const fetchCurrency = async () => {
      try {
        ...
        const response = await fetch(`${apiClient.baseURL}/users/currency`, {
          method: "GET",
          headers,
        });
    ...
    const handleStorageChange = (e: StorageEvent) => {
      ...
      if (e.key === "selectedBranch" || e.key === "selectedCurrency")
        initializePreferences();
    };
              ...
              <Dropdown>
                ...
                <DropdownMenu
                  ...
                  onSelectionChange={(keys) =>
                    handleBranchChange(Array.from(keys)[0] as string)
                  }
          ...
          {user.isAuthenticated ? (
            <Dropdown placement="bottom-end">
              ...
              <DropdownMenu aria-label="User menu" variant="flat">
                <DropdownItem
                  key="profile"
                  href={isManager ? "/bandmanager/edit-band" : "/me"}
                ...
                {isCustomer ? (
                  <DropdownItem
                    key="likes"
                    href="/likes"
                    startContent={<HeartFilledIcon className="w-4 h-4" />}
                  >
                    Liked Products
                  </DropdownItem>
                ) : null}
                ...
                {isManager ? (
                  <DropdownItem
                    key="products"
                    href="/bandmanager/manage-products"
            ...
            <NavbarItem className="sm:hidden">
              <Dropdown>
                ...
                <DropdownMenu
                  ...
                  onSelectionChange={(keys) =>
                    handleCurrencyChange(Array.from(keys)[0] as string)
                  }
                >
          ...
          {user.isAuthenticated ? (
            <>
              ...
              {isCustomer && (
                <>
                  <NavbarMenuItem>
                    <Link href="/orders" size="lg" color="foreground">
                      My Orders
                    </Link>
                  </NavbarMenuItem>
                  <NavbarMenuItem>
                    <Link href="/sent-offers" size="lg" color="foreground">
                      My Offers
                    </Link>
                  </NavbarMenuItem>
                  <NavbarMenuItem>
                    <Link href="/likes" size="lg" color="foreground">
                      Liked Products
                    </Link>
                  </NavbarMenuItem>
                </>
              ...
              {isAdmin && (
                <>
                  ...
                  <NavbarMenuItem>
                    <Link href="/admin/users" size="lg" color="foreground">
                      Manage Users
                    </Link>
                  </NavbarMenuItem>
                </>
