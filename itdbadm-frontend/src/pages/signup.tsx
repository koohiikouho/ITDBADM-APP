...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate branch selection for Band Managers
    if (formData.userType === "4" && !formData.branchId) {
      setError("Please select a branch for your band");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      // Only add branchId if user is a Band Manager
            ...
            <div className="space-y-4">
              ...
              {formData.userType === "4" && (
                <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <Globe className={`h-5 w-5 ${themeClasses.text.muted}`} />
                    </div>
                    <select
                      id="branchId"
                      name="branchId"
                  ...
                  <p className={`text-xs ${themeClasses.text.muted} mt-1`}>
                    This is where your band will be primarily based
                  </p>
                </div>
              )}
