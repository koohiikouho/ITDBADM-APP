...
INSERT INTO `bands` VALUES (1,2,1,'Kessoku Band','Rock','Indie rock band from Bocchi the Rock!',0),(2,3,1,'Ho-kago Tea Time','Pop Rock','Light music club band from K-On!',0),(3,4,2,'Poppin’Party','J-Pop','Cheerful band from BanG Dream!',0),(4,5,2,'Roselia','Symphonic Rock','Elegant and intense sound from BanG Dream!',0),(5,6,1,'Afterglow','Alt Rock','Gritty rock band from BanG Dream!',0),(6,7,2,'μ’s','Idol Pop','School idol group from Love Live!',0);
...
-- Dump completed on 2025-11-16  1:00:28
